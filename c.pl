...
print colored("[ Said-Dorker|Coded:Said-Verde-Rosso|D.R.S Dz Team  ]",'white on_blue'),"\n";
print color("white"), ">>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<< \n";
print color("white"), ">>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<<< \n";
print color("green"), "[1] Bing Dorker     |> Here You Chose Da Country Dat U Want \n";
...
print color("green"), "[4] Mass Site Grab |> Range Ip by Ip or Website list\n";
